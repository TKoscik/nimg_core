...
antsRegistration \
  ...
  -f 6x4x2x1 \
  -s 3x2x1x0vox \
  -o ${researcher}/${project}/derivatives/anat/prep/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}_temp_

mv ${researcher}/${project}/derivatives/anat/prep/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}_temp_0GenericAffine.mat \
  ${researcher}/${project}/derivatives/tform/sub-${subject}_ses-${session}_reg-${space}_${template}_tform-0affine.mat
mv ${researcher}/${project}/derivatives/anat/prep/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}_temp_1Warp.nii.gz \
  ${researcher}/${project}/derivatives/tform/sub-${subject}_ses-${session}_reg-${space}_${template}_tform-1syn.mat
mv ${researcher}/${project}/derivatives/anat/prep/sub-${subject}/ses-${session}/sub-${subject}_ses-${session}_temp_1InverseWarp.nii.gz \
